...
pub struct ModelInfo {
    ...
    pub vram_gpu: &'static str,
    pub ram_cpu: &'static str,
    pub url: String,
    pub filename: String,
...
pub fn available_models() -> Vec<ModelInfo> {
    vec![
        ModelInfo {
            ...
            description: "Ultra rapide, qualite basique, ideal CPU faible".into(),
        },
        ModelInfo {
            id: "base".into(),
            ...
            description: "Rapide, bonne qualite pour CPU".into(),
        },
        ModelInfo {
            id: "small".into(),
            ...
            description: "Bon compromis vitesse/qualite".into(),
        },
        ModelInfo {
            id: "medium".into(),
            ...
            description: "Haute qualite, necessite bon CPU ou GPU".into(),
        },
        ModelInfo {
            id: "large-v3".into(),
            ...
            description: "Meilleure qualite, GPU 10Go+ recommande".into(),
        },
        ModelInfo {
            ...
            description: "Quasi aussi precis que v3, 8x plus rapide".into(),
        },
    ]
}
